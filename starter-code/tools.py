...
TOOL_DEFINITIONS = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                "category": {
                    "type": "string",
                    "description": "Loại sản phẩm: 'xe_dien' cho ô tô/xe máy điện, hoặc 'du_lich' cho gói du lịch Vinpearl.",
                    "enum": ["xe_dien", "du_lich"]
                },
                "max_price": {
                    "type": "integer",
                    "description": "Giá tối đa tính bằng VNĐ. Nếu khách không nói, để mặc định 999999999999."
                }
            },
            "required": ["category"]
        }
    },
    {
        ...
        "description": "Ghi nhận yêu cầu hỗ trợ, khiếu nại hoặc phản hồi của khách hàng vào hệ thống.",
        "parameters": {
            "type": "object",
            "properties": {
                "customer_name": {
                ...
                "issue_description": {
                    "type": "string",
                    "description": "Mô tả chi tiết vấn đề khách hàng đang gặp phải."
                },
                "priority": {
                    "type": "string",
